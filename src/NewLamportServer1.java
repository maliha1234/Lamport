        ...
        while (true) {
            ...
            try {
                ...
                if (arr[0].contains("first")) { // if received request from client 
                    ...
                    // establish the connection with server port 5052
        ...
        t.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Logger.getLogger(NewLamportServer1.class.getName()).log(Level.SEVERE, null, ex);
                }
...
class ServerSocketHandler4 extends Thread {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(ServerSocketHandler4.class.getName()).log(Level.SEVERE, null, ex);
        }
